...
if ( ! function_exists( 'reblog_setup' ) ) :
	...
	function reblog_setup() {
		...
		add_theme_support( 'editor-color-palette', array(
	       	array(
				'name' => esc_html__( 'Blue', 'reblog' ),
				'slug' => 'blue',
				'color' => '#117eff',
	       	),
	       	array(
	           	'name' => esc_html__( 'Green', 'reblog' ),
	           	'slug' => 'green',
	           	'color' => '#07d79c',
	       	),
	       	array(
	           	'name' => esc_html__( 'Orange', 'reblog' ),
	           	'slug' => 'orange',
	           	'color' => '#ff8737',
	       	),
	       	array(
	           	'name' => esc_html__( 'Black', 'reblog' ),
	           	'slug' => 'black',
	           	'color' => '#2f3633',
	       	),
	       	array(
	           	'name' => esc_html__( 'Grey', 'reblog' ),
	           	'slug' => 'grey',
	           	'color' => '#82868b',
	       	),
	   	));
		...
		add_theme_support( 'editor-font-sizes', array(
		   	array(
		       	'name' => esc_html__( 'small', 'reblog' ),
		       	'shortName' => esc_html__( 'S', 'reblog' ),
		       	'size' => 12,
		       	'slug' => 'small'
		   	),
		   	array(
		       	'name' => esc_html__( 'regular', 'reblog' ),
		       	'shortName' => esc_html__( 'M', 'reblog' ),
		       	'size' => 16,
		       	'slug' => 'regular'
		   	),
		   	array(
		       	'name' => esc_html__( 'larger', 'reblog' ),
		       	'shortName' => esc_html__( 'L', 'reblog' ),
		       	'size' => 36,
		       	'slug' => 'larger'
		   	),
		   	array(
		       	'name' => esc_html__( 'huge', 'reblog' ),
		       	'shortName' => esc_html__( 'XL', 'reblog' ),
		       	'size' => 48,
		       	'slug' => 'huge'
		   	)
		));
...
function reblog_scripts() {
	...
	// blocks
	wp_enqueue_style( 'reblog-blocks', get_template_directory_uri() . '/assets/css/blocks.css' );
	...
	wp_enqueue_script( 'jquery-imagesloaded', get_theme_file_uri( '/assets/js/imagesloaded.pkgd.js' ), array( 'jquery' ), '20151215', true );
 ...
 * @since Reblog 1.0.0
 */
function reblog_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'reblog-block-editor-style', get_theme_file_uri( '/assets/css/editor-blocks.css' ) );
	// Add custom fonts.
	wp_enqueue_style( 'reblog-fonts', reblog_fonts_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'reblog_block_editor_styles' );
